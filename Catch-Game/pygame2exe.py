...
class BuildExe:
    def __init__(self):
        ...
        self.license = "NN License"

        #Auhor of program
        self.author_name = "ROHAN NN"
        self.author_email = "rohan.rawat.9897@gmail.com"
        self.copyright = "Copyright (r) 2018 NN."

        #Description
        self.project_description = "Catch - Catch Green, Avoid Reds."

        #Icon file (None will use pygame default icon)
        self.icon_file = None

        #Extra files/dirs copied to game
        self.extra_datas = ['1.png','2.png','3.png','4.png','5.png','6.png','7.png','8.png','back.wav','tu.wav','out.wav','win.wav']

        #Extra/excludes python modules
        self.extra_modules = []
        self.exclude_modules = ['numpy','OpenGL','email']
